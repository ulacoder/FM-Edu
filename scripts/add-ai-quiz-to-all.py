...
# Quiz компонент с AI (тот что работает)
QUIZ_COMPONENT = '''"use client";
...
print("Начинаю добавление тестов с AI...")
print("ВАЖНО: НЕ ТРОГАЮ существующий контент, только добавляю тесты!")

base_dir = r'C:\Users\Ulagat\FM-Edu\app\courses\mathematics-static'

# Проверяем файл grade7_q2
test_file = os.path.join(base_dir, 'grade7_q2', 'page.tsx')
if os.path.exists(test_file):
    with open(test_file, 'r', encoding='utf-8') as f:
        content = f.read()

    # Проверяем есть ли уже Quiz
    if 'function Quiz' in content:
        print("✓ grade7_q2 уже имеет Quiz, пропускаю")
    else:
        print("→ Добавляю Quiz в grade7_q2...")
        # TODO: добавить Quiz
        print("✅ Готово!")
else:
