  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Искусственный интеллект</h1>
          <p className="text-muted-foreground">Информатика • 11 класс • 3 четверть</p>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe
              ...
              src="https://www.youtube.com/embed/JY8kvlXbUMA"
              title="YouTube video"
