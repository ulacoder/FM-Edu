  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Неравенства</h1>
          <p className="text-muted-foreground">Математика • 8 класс • 3 четверть</p>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="my-2">Неравенство с переменной — выражение, содержащее знаки {'<'}, {'>'}, ≤, ≥. Решить неравенство — найти множество всех значений переменной, при которых оно верно. Линейное неравенство имеет вид ax+b{'>'}0 (или с другим знаком). Квадратное неравенство — ax²+bx+c{'>'}0 (или с другим знаком); решается методом интервалов через корни соответствующего квадратного уравнения (или через параболу).</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
            <p className="my-2">При делении/умножении неравенства на отрицательное число знак неравенства меняется на противоположный</p>
            <p className="my-2">Метод интервалов: найти нули функции, отметить их на числовой прямой, определить знак на каждом промежутке</p>
            <p className="my-2">Для квадратного неравенства ax²+bx+c{'>'}0 при a{'>'}0 решение — вне корней (если D{'>'}0); при a{'<'}0 — между корнями</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
            <p className="font-bold mt-4">Пример 1. Решите 3x - 6 {'>'} 0.</p>
            <p className="ml-4 text-muted-foreground">Решение: 3x{'>'}6, x{'>'}2.</p>
            <p className="font-bold mt-4">Пример 2. Решите -2x + 4 ≥ 0.</p>
            <p className="ml-4 text-muted-foreground">Решение: -2x≥-4, делим на -2, меняем знак: x≤2.</p>
            <p className="font-bold mt-4">Пример 3. Решите x²-5x+6{'<'}0.</p>
            <p className="ml-4 text-muted-foreground">Решение: Корни: x=2, x=3. Парабола вверх, между корнями функция отрицательна: 2{'<'}x{'<'}3.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <div className="aspect-video">
            <iframe
              ...
              src="https://www.youtube.com/embed/HVRkFHU0C_A"
              title="YouTube video"
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
            { question: "Решите: x²=25", options: ["x=±5", "x=5", "x=-5", "x=25"], correct: 0 },
            { question: "Вычислите дискриминант: x²-5x+6=0", options: ["1", "25", "0", "-1"], correct: 0 },
            { question: "Решите: x²-4x=0", options: ["x=0 или x=4", "x=4", "x=0", "x=-4"], correct: 0 },
            { question: "Чему равны корни x²-3x+2=0?", options: ["x=1, x=2", "x=2, x=3", "x=-1, x=-2", "нет корней"], correct: 0 },
            { question: "Решите: (x-3)(x+2)=0", options: ["x=3 или x=-2", "x=3, x=2", "x=-3, x=2", "x=1"], correct: 0 },
            { question: "При каком x: x²=0?", options: ["x=0", "нет решений", "любое x", "x=1"], correct: 0 },
            { question: "Найдите сумму корней x²-7x+10=0", options: ["7", "10", "-7", "3"], correct: 0 },
            { question: "Решите: x²+2x+1=0", options: ["x=-1", "x=1", "x=-1 и x=1", "нет корней"], correct: 0 },
            { question: "Чему равно D в x²+4x+4=0?", options: ["0", "4", "16", "-12"], correct: 0 },
            { question: "Сколько корней: x²+1=0 (в R)?", options: ["0", "1", "2", "бесконечно"], correct: 0 }
          ]} />
        </div>
