...
export default function Lesson_grade10_q3() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Производная</h1>
          <p className="text-muted-foreground">Математика • 10 класс • 3 четверть</p>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="my-2">Производная функции f(x) в точке x — предел отношения приращения функции к приращению аргумента при стремлении последнего к нулю. Обозначается f'(x). Геометрический смысл: f'(x₀) — угловой коэффициент касательной к графику в точке x₀. Физический смысл: мгновенная скорость изменения величины.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
            <p className="my-2">(xⁿ)' = n·xⁿ⁻¹</p>
            <p className="my-2">(sinx)' = cosx; (cosx)' = -sinx</p>
            <p className="my-2">(u+v)' = u'+v'; (u·v)' = u'v+uv'; (u/v)' = (u'v-uv')/v²</p>
            <p className="my-2">(c)' = 0 (производная константы)</p>
            <p className="my-2">(k·f(x))' = k·f'(x)</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
            <p className="font-bold mt-4">Пример 1. Найдите производную f(x)=x³-4x²+2.</p>
            <p className="ml-4 text-muted-foreground">Решение: f'(x)=3x²-8x.</p>
            <p className="font-bold mt-4">Пример 2. Найдите производную f(x)=x²·sinx.</p>
            <p className="ml-4 text-muted-foreground">Решение: По правилу произведения: f'(x)=2x·sinx + x²·cosx.</p>
            <p className="font-bold mt-4">Пример 3. Найдите угловой коэффициент касательной к y=x² в точке x=3.</p>
            <p className="ml-4 text-muted-foreground">Решение: y'=2x, при x=3: y'(3)=6. Угловой коэффициент равен 6.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <div className="aspect-video">
            <iframe
              ...
              src="https://www.youtube.com/embed/XvJ5VsxWdDg"
              title="YouTube video"
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
            { question: "Чему равен sin(π/6)?", options: ["1/2", "√3/2", "√2/2", "1"], correct: 0 },
            { question: "Вычислите: cos(π/3)", options: ["1/2", "√3/2", "√2/2", "0"], correct: 0 },
            { question: "Чему равен период sinx?", options: ["2π", "π", "π/2", "4π"], correct: 0 },
            { question: "Найдите tg(π/4)", options: ["1", "√3", "1/√3", "0"], correct: 0 },
            { question: "Чему равен sin(π/2)?", options: ["1", "0", "√2/2", "-1"], correct: 0 },
            { question: "Вычислите: cos(π)", options: ["-1", "1", "0", "π"], correct: 0 },
            { question: "Чему равен период cosx?", options: ["2π", "π", "π/2", "4π"], correct: 0 },
            { question: "Найдите sin(0)", options: ["0", "1", "-1", "не определено"], correct: 0 },
            { question: "Чему равен cos(π/2)?", options: ["0", "1", "-1", "√2/2"], correct: 0 },
            { question: "Вычислите: tg(0)", options: ["0", "1", "не определено", "∞"], correct: 0 }
          ]} />
        </div>
