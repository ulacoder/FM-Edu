...
export default function Lesson_grade9_q1() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Уравнения и неравенства</h1>
          <p className="text-muted-foreground">Математика • 9 класс • 1 четверть</p>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="my-2">Уравнение высшей степени — уравнение степени выше второй. Основные методы решения: разложение на множители (в т.ч. вынесение общего множителя, группировка), замена переменной (например, для биквадратных уравнений x⁴+px²+q=0), подбор корня и деление многочлена (схема Горнера).</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
            <p className="my-2">Биквадратное уравнение ax⁴+bx²+c=0 решается заменой t=x² (t≥0)</p>
            <p className="my-2">Если сумма коэффициентов уравнения равна нулю, x=1 — корень</p>
            <p className="my-2">Разложение через вынесение общего множителя: ax³+bx² = x²(ax+b)</p>
            <p className="my-2">Произведение равно нулю, если хотя бы один из множителей равен нулю</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
            <p className="font-bold mt-4">Пример 1. Решите x⁴-5x²+4=0.</p>
            <p className="ml-4 text-muted-foreground">Решение: Замена t=x²: t²-5t+4=0, t=1 или t=4. x²=1 → x=±1; x²=4 → x=±2.</p>
            <p className="font-bold mt-4">Пример 2. Решите x³-4x=0.</p>
            <p className="ml-4 text-muted-foreground">Решение: x(x²-4)=0 → x=0 или x²=4 → x=0, x=2, x=-2.</p>
            <p className="font-bold mt-4">Пример 3. Решите x³-3x²+3x-1=0.</p>
            <p className="ml-4 text-muted-foreground">Решение: Это (x-1)³=0, значит x=1 (корень кратности 3).</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <div className="aspect-video">
            <iframe
              ...
              src="https://www.youtube.com/embed/MjBFB6O9leI"
              title="YouTube video"
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
            { question: "Чему равно sin30°?", options: ["1/2", "√3/2", "√2/2", "1"], correct: 0 },
            { question: "Вычислите: cos0°", options: ["1", "0", "-1", "√2/2"], correct: 0 },
            { question: "Чему равно tg45°?", options: ["1", "√3", "1/√3", "0"], correct: 0 },
            { question: "Найдите sin90°", options: ["1", "0", "√2/2", "нет значения"], correct: 0 },
            { question: "Чему равно sin²α+cos²α?", options: ["1", "0", "2", "зависит от α"], correct: 0 },
            { question: "Вычислите: cos60°", options: ["1/2", "√3/2", "√2/2", "0"], correct: 0 },
            { question: "Чему равен tg0°?", options: ["0", "1", "нет значения", "∞"], correct: 0 },
            { question: "Найдите sin(-α)", options: ["-sinα", "sinα", "cosα", "0"], correct: 0 },
            { question: "В каком треугольнике a²=b²+c²?", options: ["Прямоугольном", "Равностороннем", "Тупоугольном", "Любом"], correct: 0 },
            { question: "Чему равен sin(180°-α)?", options: ["sinα", "-sinα", "cosα", "0"], correct: 0 }
          ]} />
        </div>
