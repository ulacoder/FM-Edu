...
export default function Lesson_grade10_q2() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Тригонометрические уравнения</h1>
          <p className="text-muted-foreground">Математика • 10 класс • 2 четверть</p>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="my-2">Тригонометрическое уравнение — уравнение, где неизвестное стоит под знаком тригонометрической функции. Простейшие уравнения: sinx=a, cosx=a, tgx=a, ctgx=a. Решаются через формулы общих решений или сведением к простейшим (разложение на множители, замена переменной).</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
            <p className="my-2">sinx=a (|a|≤1): x = (-1)ⁿ·arcsin(a) + πn, n∈Z</p>
            <p className="my-2">cosx=a (|a|≤1): x = ±arccos(a) + 2πn, n∈Z</p>
            <p className="my-2">tgx=a: x = arctg(a) + πn, n∈Z</p>
            <p className="my-2">sinx=0: x=πn; cosx=0: x=π/2+πn</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
            <p className="font-bold mt-4">Пример 1. Решите sinx = 1/2.</p>
            <p className="ml-4 text-muted-foreground">Решение: x = (-1)ⁿ·(π/6) + πn, n∈Z.</p>
            <p className="font-bold mt-4">Пример 2. Решите cosx = -1.</p>
            <p className="ml-4 text-muted-foreground">Решение: cosx=-1 при x=π+2πn, n∈Z.</p>
            <p className="font-bold mt-4">Пример 3. Решите 2cos²x - cosx - 1 = 0.</p>
            <p className="ml-4 text-muted-foreground">Решение: Замена t=cosx: 2t²-t-1=0, t=1 или t=-1/2. cosx=1 → x=2πn; cosx=-1/2 → x=±2π/3+2πn.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <div className="aspect-video">
            <iframe
              ...
              src="https://www.youtube.com/embed/8V8rBQRis3E"
              title="YouTube video"
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
            { question: "Чему равна производная x²?", options: ["2x", "x", "x²", "2"], correct: 0 },
            { question: "Найдите f'(x) для f(x)=5x", options: ["5", "5x", "x", "0"], correct: 0 },
            { question: "Вычислите производную sinx", options: ["cosx", "-cosx", "sinx", "-sinx"], correct: 0 },
            { question: "Чему равна (x³)'?", options: ["3x²", "x²", "3x", "x³"], correct: 0 },
            { question: "Найдите производную C (константы)", options: ["0", "C", "1", "не определено"], correct: 0 },
            { question: "Чему равна (eˣ)'?", options: ["eˣ", "xeˣ⁻¹", "eˣ⁻¹", "e"], correct: 0 },
            { question: "Производная 1/x?", options: ["-1/x²", "1/x²", "-x²", "1/x"], correct: 0 },
            { question: "Чему равна (cosx)'?", options: ["-sinx", "sinx", "-cosx", "cosx"], correct: 0 },
            { question: "Найдите (√x)'", options: ["1/(2√x)", "1/√x", "√x", "2√x"], correct: 0 },
            { question: "Вычислите (lnx)'", options: ["1/x", "ln", "x", "1"], correct: 0 }
          ]} />
        </div>
