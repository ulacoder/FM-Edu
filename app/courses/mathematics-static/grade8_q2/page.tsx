  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Квадратные уравнения</h1>
          <p className="text-muted-foreground">Математика • 8 класс • 2 четверть</p>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="my-2">Квадратное уравнение — уравнение вида ax²+bx+c=0 (a≠0). Дискриминант D=b²-4ac определяет число корней: D{'>'}0 — два корня, D=0 — один корень, D{'<'}0 — корней нет (в действительных числах). Теорема Виета связывает корни приведённого квадратного уравнения с его коэффициентами.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
            <p className="my-2">D = b² - 4ac</p>
            <p className="my-2">x₁,₂ = (-b ± √D) / (2a)</p>
            <p className="my-2">Теорема Виета (для x²+px+q=0): x₁+x₂ = -p, x₁·x₂ = q</p>
            <p className="my-2">Для общего вида ax²+bx+c=0: x₁+x₂ = -b/a, x₁·x₂ = c/a</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
            <p className="font-bold mt-4">Пример 1. Решите x² - 5x + 6 = 0.</p>
            <p className="ml-4 text-muted-foreground">Решение: D = 25-24 = 1. x = (5±1)/2 → x₁=3, x₂=2.</p>
            <p className="font-bold mt-4">Пример 2. Решите по теореме Виета: x²-7x+10=0.</p>
            <p className="ml-4 text-muted-foreground">Решение: Ищем числа с суммой 7 и произведением 10: это 5 и 2. Ответ: x₁=5, x₂=2.</p>
            <p className="font-bold mt-4">Пример 3. Решите 2x²+3x-2=0.</p>
            <p className="ml-4 text-muted-foreground">Решение: D=9+16=25. x=(-3±5)/4 → x₁=0,5, x₂=-2.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <div className="aspect-video">
            <iframe
              ...
              src="https://www.youtube.com/embed/y8zkDxXR0-E"
              title="YouTube video"
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
            { question: "Чему равно 2⁰?", options: ["1", "0", "2", "неопределено"], correct: 0 },
            { question: "Вычислите: 3²·3³", options: ["3⁵", "3⁶", "9⁵", "6⁵"], correct: 0 },
            { question: "Чему равно (2³)²?", options: ["2⁶", "2⁵", "4⁶", "6²"], correct: 0 },
            { question: "Упростите: x⁵/x²", options: ["x³", "x⁷", "x", "1/x³"], correct: 0 },
            { question: "Чему равно 5⁻²?", options: ["1/25", "1/5", "-25", "25"], correct: 0 },
            { question: "Вычислите: (1/2)⁻³", options: ["8", "1/8", "-8", "6"], correct: 0 },
            { question: "Чему равно a⁰ при a≠0?", options: ["1", "0", "a", "неопределено"], correct: 0 },
            { question: "Упростите: (ab)³", options: ["a³b³", "ab³", "3ab", "a+b³"], correct: 0 },
            { question: "Вычислите: 10³·10⁻²", options: ["10", "10⁵", "100", "1"], correct: 0 },
            { question: "Чему равно √(2⁶)?", options: ["2³=8", "2⁶", "√6", "6"], correct: 0 }
          ]} />
        </div>
