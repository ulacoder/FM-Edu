  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Квадратные корни</h1>
          <p className="text-muted-foreground">Математика • 8 класс • 1 четверть</p>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="my-2">Арифметическим квадратным корнем из неотрицательного числа a называется такое неотрицательное число b, что b² = a (обозначается √a). Подкоренное выражение должно быть неотрицательным. Числа, не являющиеся квадратами рациональных чисел (√2, √3 и т.д.), — иррациональные.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
            <p className="my-2">√a определён только при a ≥ 0, и √a ≥ 0</p>
            <p className="my-2">√(a·b) = √a · √b (при a≥0, b≥0)</p>
            <p className="my-2">√(a/b) = √a / √b (при a≥0, b{'>'}0)</p>
            <p className="my-2">√(a²) = |a|</p>
            <p className="my-2">(√a)² = a при a≥0</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
            <p className="font-bold mt-4">Пример 1. Вычислите √144.</p>
            <p className="ml-4 text-muted-foreground">Решение: 12² = 144, значит √144 = 12.</p>
            <p className="font-bold mt-4">Пример 2. Упростите √48.</p>
            <p className="ml-4 text-muted-foreground">Решение: 48 = 16·3, √48 = √16·√3 = 4√3.</p>
            <p className="font-bold mt-4">Пример 3. Вычислите √2 · √8.</p>
            <p className="ml-4 text-muted-foreground">Решение: √(2·8) = √16 = 4.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <div className="aspect-video">
            <iframe
              ...
              src="https://www.youtube.com/embed/OfjhidLS5E4"
              title="YouTube video"
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
            { question: "Чему равно √16?", options: ["4", "8", "2", "16"], correct: 0 },
            { question: "Упростите: √50", options: ["5√2", "2√5", "√50", "25"], correct: 0 },
            { question: "Вычислите: √9·√4", options: ["6", "√36", "3", "12"], correct: 0 },
            { question: "Чему равно (√3)²?", options: ["3", "9", "√3", "6"], correct: 0 },
            { question: "Упростите: √(25/4)", options: ["5/2", "25/4", "5/4", "√25/√4"], correct: 0 },
            { question: "Вынесите множитель: √18", options: ["3√2", "2√3", "√18", "9"], correct: 0 },
            { question: "Вычислите: √100-√25", options: ["5", "√75", "15", "10"], correct: 0 },
            { question: "Чему равно √(a²)?", options: ["|a|", "a", "a²", "±a"], correct: 0 },
            { question: "Упростите: √32", options: ["4√2", "2√8", "8√2", "√32"], correct: 0 },
            { question: "Рационально ли √5?", options: ["Нет", "Да", "Зависит", "Только положительное"], correct: 0 }
          ]} />
        </div>
