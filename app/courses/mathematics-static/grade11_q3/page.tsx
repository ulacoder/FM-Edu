...
export default function Lesson_grade11_q3() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Логарифмическая функция</h1>
          <p className="text-muted-foreground">Математика • 11 класс • 3 четверть</p>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="my-2">Логарифмом числа b по основанию a (a{'>'}0, a≠1, b{'>'}0) называется показатель степени, в которую нужно возвести a, чтобы получить b: logₐb=c ⟺ aᶜ=b. Логарифмическая функция y=logₐx — обратная показательной. Область определения (0;+∞), область значений — все действительные числа.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
            <p className="my-2">logₐ(xy) = logₐx + logₐy</p>
            <p className="my-2">logₐ(x/y) = logₐx - logₐy</p>
            <p className="my-2">logₐ(xⁿ) = n·logₐx</p>
            <p className="my-2">Переход к новому основанию: logₐb = logₙb/logₙa</p>
            <p className="my-2">logₐa=1; logₐ1=0</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
            <p className="font-bold mt-4">Пример 1. Вычислите log₂8.</p>
            <p className="ml-4 text-muted-foreground">Решение: 2³=8, значит log₂8=3.</p>
            <p className="font-bold mt-4">Пример 2. Решите log₃x=2.</p>
            <p className="ml-4 text-muted-foreground">Решение: x=3²=9.</p>
            <p className="font-bold mt-4">Пример 3. Вычислите log₅25 + log₅5.</p>
            <p className="ml-4 text-muted-foreground">Решение: log₅25=2, log₅5=1. Сумма = 3.</p>
          </div>
  
        <div className="bg-card rounded-xl border border-border/60 p-8">
          <h2 className="text-2xl font-bold mb-6">Тест на понимание 📝</h2>
          <Quiz questions={[
            { question: "Сколько рёбер у куба?", options: ["12", "6", "8", "16"], correct: 0 },
            { question: "Найдите объём конуса r=3, h=4", options: ["12π", "36π", "9π", "16π"], correct: 0 },
            { question: "Чему равна площадь поверхности сферы r=5?", options: ["100π", "50π", "25π", "500π/3"], correct: 0 },
            { question: "Найдите объём пирамиды S=20, h=6", options: ["40", "120", "60", "20"], correct: 0 },
            { question: "Сколько граней у параллелепипеда?", options: ["6", "8", "12", "4"], correct: 0 },
            { question: "Чему равен объём шара r=3?", options: ["36π", "12π", "27π", "9π"], correct: 0 },
            { question: "Найдите объём призмы S_осн=10, h=5", options: ["50", "15", "100", "25"], correct: 0 },
            { question: "Чему равна площадь боковой поверхности цилиндра r=2, h=3?", options: ["12π", "6π", "18π", "24π"], correct: 0 },
            { question: "Сколько вершин у тетраэдра?", options: ["4", "6", "8", "12"], correct: 0 },
            { question: "Найдите диагональ куба a=1", options: ["√3", "1", "√2", "3"], correct: 0 }
          ]} />
        </div>
