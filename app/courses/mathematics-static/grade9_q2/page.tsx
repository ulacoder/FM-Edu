...
export default function Lesson_grade9_q2() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Последовательности</h1>
          <p className="text-muted-foreground">Математика • 9 класс • 2 четверть</p>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="my-2">Арифметическая прогрессия — последовательность, в которой каждый следующий член получается прибавлением к предыдущему одного и того же числа d (разность прогрессии). Геометрическая прогрессия — последовательность, где каждый следующий член получается умножением предыдущего на одно и то же число q≠0 (знаменатель прогрессии).</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
            <p className="my-2">aₙ = a₁ + (n-1)d — n-й член арифметической прогрессии</p>
            <p className="my-2">Sₙ = (a₁+aₙ)·n/2 — сумма первых n членов арифметической прогрессии</p>
            <p className="my-2">bₙ = b₁·qⁿ⁻¹ — n-й член геометрической прогрессии</p>
            <p className="my-2">Sₙ = b₁(qⁿ-1)/(q-1) при q≠1 — сумма n членов геометрической прогрессии</p>
            <p className="my-2">S = b₁/(1-q) при |q|{'<'}1 — сумма бесконечно убывающей геометрической прогрессии</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
            <p className="font-bold mt-4">Пример 1. Найдите 10-й член прогрессии 2,5,8,11,...</p>
            <p className="ml-4 text-muted-foreground">Решение: a₁=2, d=3. a₁₀=2+9·3=29.</p>
            <p className="font-bold mt-4">Пример 2. Найдите сумму первых 20 членов прогрессии 3,7,11,...</p>
            <p className="ml-4 text-muted-foreground">Решение: d=4, a₂₀=3+19·4=79. S₂₀=(3+79)·20/2=820.</p>
            <p className="font-bold mt-4">Пример 3. Найдите сумму бесконечной геометрической прогрессии 1, 1/2, 1/4, ...</p>
            <p className="ml-4 text-muted-foreground">Решение: b₁=1, q=1/2. S=1/(1-0,5)=2.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <div className="aspect-video">
            <iframe
              ...
              src="https://www.youtube.com/embed/vXOEfy4cKmo"
              title="YouTube video"
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
            { question: "Чему равна сумма арифметической прогрессии 1,3,5,...(10 членов)?", options: ["100", "55", "50", "110"], correct: 0 },
            { question: "Найдите a₅ в прогрессии: 2,5,8,...", options: ["14", "11", "17", "20"], correct: 0 },
            { question: "Чему равна разность в 3,7,11,...?", options: ["4", "3", "7", "8"], correct: 0 },
            { question: "Найдите сумму первых 5 членов геометрической прогрессии 2,4,8,...", options: ["62", "32", "64", "30"], correct: 0 },
            { question: "Чему равен знаменатель в 3,6,12,...?", options: ["2", "3", "4", "6"], correct: 0 },
            { question: "Найдите 4-й член в 1,3,9,...", options: ["27", "12", "18", "81"], correct: 0 },
            { question: "Является ли 5,5,5,... прогрессией?", options: ["Да, арифметической с d=0", "Нет", "Да, геометрической", "Зависит"], correct: 0 },
            { question: "Чему равна сумма 1+2+3+...+100?", options: ["5050", "5000", "5100", "10000"], correct: 0 },
            { question: "Найдите a₁₀ в 1,2,4,8,...", options: ["512", "256", "1024", "128"], correct: 0 },
            { question: "Чему равен a_n в арифм. прогрессии?", options: ["a₁+(n-1)d", "a₁+nd", "a₁·qⁿ", "a₁·qⁿ⁻¹"], correct: 0 }
          ]} />
        </div>
