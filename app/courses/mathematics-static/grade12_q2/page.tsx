...
export default function Lesson_grade12_q2() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Элементы комбинаторики</h1>
          <p className="text-muted-foreground">Математика • 12 класс • 2 четверть</p>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="my-2">Комбинаторика изучает способы подсчёта числа комбинаций элементов. Перестановки — упорядочения всех n элементов множества. Размещения — упорядоченные выборки m элементов из n. Сочетания — неупорядоченные выборки m элементов из n (порядок не важен).</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
            <p className="my-2">Перестановки: Pₙ = n! = 1·2·3·...·n</p>
            <p className="my-2">Размещения: Aₙᵐ = n!/(n-m)!</p>
            <p className="my-2">Сочетания: Cₙᵐ = n!/(m!(n-m)!)</p>
            <p className="my-2">Правило произведения: если событие A можно осуществить m способами, а после него B — n способами, то оба вместе — m·n способами</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
            <p className="font-bold mt-4">Пример 1. Сколькими способами можно расставить 4 книги на полке?</p>
            <p className="ml-4 text-muted-foreground">Решение: P₄ = 4! = 24.</p>
            <p className="font-bold mt-4">Пример 2. Сколько трёхзначных чисел можно составить из цифр 1,2,3,4 без повторений (важен порядок)?</p>
            <p className="ml-4 text-muted-foreground">Решение: A₄³ = 4!/(4-3)! = 24/1 = 24.</p>
            <p className="font-bold mt-4">Пример 3. Сколькими способами можно выбрать 3 человек из 7 для комиссии (порядок не важен)?</p>
            <p className="ml-4 text-muted-foreground">Решение: C₇³ = 7!/(3!·4!) = 35.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <div className="aspect-video">
            <iframe
              ...
              src="https://www.youtube.com/embed/5AyC2XjM_1w"
              title="YouTube video"
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
            { question: "Решите: sinx=1", options: ["x=π/2+2πn", "x=π+2πn", "x=0+2πn", "x=2πn"], correct: 0 },
            { question: "Найдите x: cosx=0", options: ["x=π/2+πn", "x=πn", "x=2πn", "x=π/4+πn"], correct: 0 },
            { question: "Решите: tgx=1", options: ["x=π/4+πn", "x=π/2+πn", "x=πn", "x=π+πn"], correct: 0 },
            { question: "Чему равен x в sinx=0?", options: ["x=πn", "x=2πn", "x=π/2+2πn", "x=π+2πn"], correct: 0 },
            { question: "Решите: cosx=1", options: ["x=2πn", "x=πn", "x=π+2πn", "x=π/2+2πn"], correct: 0 },
            { question: "Найдите x: sinx=-1", options: ["x=-π/2+2πn", "x=π/2+2πn", "x=π+2πn", "x=2πn"], correct: 0 },
            { question: "Решите: tgx=0", options: ["x=πn", "x=2πn", "x=π/2+πn", "нет решений"], correct: 0 },
            { question: "Чему равен x в cosx=-1?", options: ["x=π+2πn", "x=2πn", "x=π/2+2πn", "x=πn"], correct: 0 },
            { question: "Решите: sin2x=0", options: ["x=πn/2", "x=πn", "x=2πn", "x=π/4+πn"], correct: 0 },
            { question: "Найдите x: cos(x/2)=0", options: ["x=π+2πn", "x=πn", "x=π/2+πn", "x=2πn"], correct: 0 }
          ]} />
        </div>
