  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Волновая оптика</h1>
          <p className="text-muted-foreground">Физика • 12 класс • 2 четверть</p>
        </div>
...
<p className="my-2"><strong>Интерференция</strong> — наложение когерентных волн, при котором образуется устойчивая картина усиления и ослабления колебаний.</p>
<p className="my-2"><strong>Дифракция</strong> — огибание волнами препятствий.</p>
<p className="my-2"><strong>Дисперсия</strong> — зависимость показателя преломления от длины волны.</p>
<p className="my-2"><strong>Поляризация</strong> — выделение волн с определённым направлением колебаний.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">Δd = kλ — условие максимума интерференции</p>
<p className="my-2">Δd = (2k+1)λ/2 — условие минимума</p>
<p className="my-2">d·sinφ = kλ — дифракционная решётка</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Разность хода волн 2 мкм, длина волны 0,5 мкм. Определите порядок интерференционного максимума.</p>
<p className="ml-4 text-muted-foreground">Решение: k = Δd/λ = 2/0,5 = 4.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/qCmtegdqOOA" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Что такое интерференция?", options: ["Наложение когерентных волн", "Огибание препятствий", "Разложение света", "Поглощение света"], correct: 0 },
{ question: "Что такое дифракция?", options: ["Огибание волнами препятствий", "Наложение волн", "Отражение света", "Преломление света"], correct: 0 },
{ question: "Условие максимума интерференции?", options: ["Δd = kλ", "Δd = λ/2", "Δd = 0", "Δd = 2λ"], correct: 0 },
{ question: "Дисперсия — это?", options: ["Разложение света на спектр", "Огибание препятствий", "Наложение волн", "Отражение"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
