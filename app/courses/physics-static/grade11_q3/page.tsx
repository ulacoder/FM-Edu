  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Электромагнитные колебания</h1>
          <p className="text-muted-foreground">Физика • 11 класс • 3 четверть</p>
        </div>
...
<p className="my-2"><strong>Колебательный контур</strong> — система из конденсатора и катушки индуктивности.</p>
<p className="my-2"><strong>Переменный ток</strong> — ток, периодически изменяющийся по величине и направлению.</p>
<p className="my-2"><strong>Резонанс</strong> — резкое возрастание амплитуды колебаний при совпадении частот.</p>
<p className="my-2"><strong>Трансформатор</strong> — устройство для преобразования напряжения переменного тока.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">T = 2π√(LC) — период колебаний в контуре</p>
<p className="my-2">ω = 1/√(LC) — циклическая частота</p>
<p className="my-2">U₁/U₂ = n₁/n₂ — формула трансформатора</p>
<p className="my-2">I = U/Z — закон Ома для переменного тока</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Катушка индуктивностью 0,1 Гн и конденсатор ёмкостью 100 мкФ. Найдите период колебаний.</p>
<p className="ml-4 text-muted-foreground">Решение: T = 2π√(LC) = 2·3,14·√(0,1·10⁻⁴) ≈ 0,02 с.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/AC6LKMeB0aQ" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Формула периода колебаний в контуре?", options: ["T = 2π√(LC)", "T = 1/ν", "T = 2π√(m/k)", "T = 2π/ω"], correct: 0 },
{ question: "Что такое резонанс?", options: ["Резкое возрастание амплитуды при совпадении частот", "Затухание колебаний", "Изменение частоты", "Остановка колебаний"], correct: 0 },
{ question: "Формула трансформатора?", options: ["U₁/U₂ = n₁/n₂", "U₁ = U₂", "U₁·U₂ = const", "U₁ + U₂ = 0"], correct: 0 },
{ question: "Что преобразует трансформатор?", options: ["Напряжение переменного тока", "Постоянный ток", "Сопротивление", "Частоту"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
