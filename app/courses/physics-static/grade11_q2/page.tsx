...
export default function Lesson_grade11_q2() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Электромагнитная индукция</h1>
          <p className="text-muted-foreground">Физика • 11 класс • 2 четверть</p>
        </div>
...
<p className="my-2"><strong>Электромагнитная индукция</strong> — явление возникновения тока в замкнутом контуре при изменении магнитного потока через него.</p>
<p className="my-2"><strong>Закон электромагнитной индукции Фарадея:</strong> ЭДС индукции равна скорости изменения магнитного потока.</p>
<p className="my-2"><strong>Правило Ленца:</strong> индукционный ток направлен так, чтобы противодействовать причине, его вызвавшей.</p>
<p className="my-2"><strong>Самоиндукция</strong> — явление возникновения ЭДС индукции в контуре при изменении тока в нём самом.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">ε_i = -ΔΦ/Δt — закон Фарадея</p>
<p className="my-2">ε_s = -L·ΔI/Δt — ЭДС самоиндукции</p>
<p className="my-2">W = LI²/2 — энергия магнитного поля</p>
<p className="my-2">L — индуктивность, Генри (Гн)</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Магнитный поток через контур изменился на 0,04 Вб за 0,02 с. Найдите ЭДС индукции.</p>
<p className="ml-4 text-muted-foreground">Решение: ε = ΔΦ/Δt = 0,04 / 0,02 = 2 В.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/vqDbMEdLiCs" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Закон электромагнитной индукции?", options: ["ε = -ΔΦ/Δt", "ε = BIl", "ε = IR", "ε = UI"], correct: 0 },
{ question: "Правило Ленца определяет?", options: ["Направление индукционного тока", "Величину тока", "Сопротивление", "Напряжение"], correct: 0 },
{ question: "Формула ЭДС самоиндукции?", options: ["ε = -LΔI/Δt", "ε = -ΔΦ/Δt", "ε = IR", "ε = BIl"], correct: 0 },
{ question: "Единица индуктивности?", options: ["Генри (Гн)", "Тесла (Тл)", "Вебер (Вб)", "Ом (Ом)"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
