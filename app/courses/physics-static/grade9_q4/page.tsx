  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Механические колебания и волны</h1>
          <p className="text-muted-foreground">Физика • 9 класс • 4 четверть</p>
        </div>
...
<p className="my-2"><strong>Колебания</strong> — движения, повторяющиеся через равные промежутки времени.</p>
<p className="my-2"><strong>Амплитуда (A)</strong> — максимальное отклонение от положения равновесия.</p>
<p className="my-2"><strong>Период (T)</strong> — время одного полного колебания.</p>
<p className="my-2"><strong>Частота (ν)</strong> — число колебаний в единицу времени.</p>
<p className="my-2"><strong>Волна</strong> — распространение колебаний в пространстве.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">T = 2π√(l/g) (период математического маятника)</p>
<p className="my-2">T = 2π√(m/k) (период пружинного маятника)</p>
<p className="my-2">ν = 1/T (частота)</p>
<p className="my-2">v = λν (скорость волны)</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Период колебаний 0,5 с. Найдите частоту.</p>
<p className="ml-4 text-muted-foreground">Решение: ν = 1/T = 1/0,5 = 2 Гц.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/zJZJ8Ms20Sg" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Что такое период колебаний?", options: ["Время одного полного колебания", "Число колебаний", "Амплитуда", "Скорость"], correct: 0 },
{ question: "Формула частоты?", options: ["ν = 1/T", "ν = T", "ν = 1/A", "ν = T²"], correct: 0 },
{ question: "Единица частоты?", options: ["Герц (Гц)", "Секунда (с)", "Метр (м)", "Ньютон (Н)"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
