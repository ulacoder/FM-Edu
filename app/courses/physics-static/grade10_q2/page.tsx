  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Термодинамика</h1>
          <p className="text-muted-foreground">Физика • 10 класс • 2 четверть</p>
        </div>
...
<p className="my-2"><strong>Термодинамика</strong> — раздел физики, изучающий тепловые процессы.</p>
<p className="my-2"><strong>Внутренняя энергия идеального газа</strong> — сумма кинетических энергий всех молекул.</p>
<p className="my-2"><strong>I закон термодинамики:</strong> изменение внутренней энергии равно сумме работы и количества теплоты (ΔU = Q + A).</p>
<p className="my-2"><strong>Изопроцессы:</strong> изотермический (T=const), изобарный (p=const), изохорный (V=const).</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">ΔU = Q + A (I закон термодинамики)</p>
<p className="my-2">A = -p∆V (работа газа)</p>
<p className="my-2">η = A/Q₁ = 1 - Q₂/Q₁ (КПД тепловой машины)</p>
<p className="my-2">Изотермический: pV = const</p>
<p className="my-2">Изобарный: V/T = const</p>
<p className="my-2">Изохорный: p/T = const</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Газу передали 500 Дж теплоты, он совершил работу 300 Дж. Найдите изменение внутренней энергии.</p>
<p className="ml-4 text-muted-foreground">Решение: ΔU = Q - A' = 500 - 300 = 200 Дж.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/L8a3e_V4SWQ" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "I закон термодинамики?", options: ["ΔU = Q + A", "ΔU = Q - A", "U = Q + A", "Q = U + A"], correct: 0 },
{ question: "При изотермическом процессе постоянна?", options: ["Температура", "Давление", "Объём", "Внутренняя энергия"], correct: 0 },
{ question: "Формула КПД тепловой машины?", options: ["η = A/Q₁", "η = Q₁/A", "η = Q₂/Q₁", "η = A·Q₁"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
