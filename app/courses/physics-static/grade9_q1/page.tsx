  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Кинематика</h1>
          <p className="text-muted-foreground">Физика • 9 класс • 1 четверть</p>
        </div>
...
<p className="my-2"><strong>Кинематика</strong> — раздел механики, изучающий движение без учёта причин.</p>
<p className="my-2"><strong>Равноускоренное движение</strong> — движение с постоянным ускорением.</p>
<p className="my-2"><strong>Ускорение (a)</strong> — изменение скорости в единицу времени.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">v = v₀ + at</p>
<p className="my-2">s = v₀t + at²/2</p>
<p className="my-2">v² = v₀² + 2as</p>
<p className="my-2">a = (v - v₀)/t</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Тело начало движение со скоростью 2 м/с и ускорением 3 м/с². Какова скорость через 4 с?</p>
<p className="ml-4 text-muted-foreground">Решение: v = v₀ + at = 2 + 3·4 = 14 м/с.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/sJG-rXBbmCc" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Что изучает кинематика?", options: ["Движение тел без учёта причин", "Причины движения", "Силы", "Энергию"], correct: 0 },
{ question: "Формула скорости при равноускоренном движении?", options: ["v = v₀ + at", "v = v₀ - at", "v = at", "v = v₀t"], correct: 0 },
{ question: "Единица ускорения?", options: ["м/с²", "м/с", "м", "с"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
