  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Молекулярная физика. МКТ</h1>
          <p className="text-muted-foreground">Физика • 10 класс • 1 четверть</p>
        </div>
...
<p className="my-2"><strong>Молекулярно-кинетическая теория (МКТ)</strong> — теория, объясняющая свойства тел движением и взаимодействием молекул.</p>
<p className="my-2"><strong>Основные положения МКТ:</strong></p>
<p className="my-2">1. Все тела состоят из молекул.</p>
<p className="my-2">2. Молекулы находятся в непрерывном хаотическом движении.</p>
<p className="my-2">3. Молекулы взаимодействуют друг с другом.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">pV = (m/M)RT (уравнение Менделеева-Клапейрона)</p>
<p className="my-2">pV = NkT (уравнение состояния)</p>
<p className="my-2">E_к = (3/2)kT (средняя кинетическая энергия молекулы)</p>
<p className="my-2">p = (1/3)nm₀v² (основное уравнение МКТ)</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Газ при давлении 10⁵ Па занимает объём 2 м³ при температуре 300 К. Найдите количество вещества.</p>
<p className="ml-4 text-muted-foreground">Решение: ν = pV/RT = (10⁵ · 2)/(8,31 · 300) ≈ 80 моль.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/Mysr5_K_jCY" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Основное положение МКТ?", options: ["Все тела состоят из молекул", "Молекулы не движутся", "Молекулы не взаимодействуют", "Молекул не существует"], correct: 0 },
{ question: "Уравнение Менделеева-Клапейрона?", options: ["pV = (m/M)RT", "pV = mRT", "p = VRT", "V = pRT"], correct: 0 },
{ question: "От чего зависит давление газа?", options: ["От температуры и концентрации молекул", "Только от температуры", "Только от объёма", "Не зависит ни от чего"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
