  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Закон Ома</h1>
          <p className="text-muted-foreground">Физика • 8 класс • 4 четверть</p>
        </div>
...
<p className="my-2"><strong>Закон Ома для участка цепи:</strong> сила тока в участке цепи прямо пропорциональна напряжению и обратно пропорциональна сопротивлению.</p>
<p className="my-2"><strong>Последовательное соединение:</strong> проводники соединены друг за другом.</p>
<p className="my-2"><strong>Параллельное соединение:</strong> начала и концы проводников соединены в общие точки.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">I = U/R (закон Ома)</p>
<p className="my-2">Последовательное: I = I₁ = I₂, U = U₁ + U₂, R = R₁ + R₂</p>
<p className="my-2">Параллельное: U = U₁ = U₂, I = I₁ + I₂, 1/R = 1/R₁ + 1/R₂</p>
<p className="my-2">P = UI (мощность)</p>
<p className="my-2">A = UIt (работа тока)</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Напряжение на участке цепи 12 В, сопротивление 4 Ом. Найдите силу тока.</p>
<p className="ml-4 text-muted-foreground">Решение: I = U/R = 12 В / 4 Ом = 3 А.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/AmtmMqyZ9k0" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Закон Ома для участка цепи?", options: ["I = U/R", "I = R/U", "I = UR", "U = IR"], correct: 0 },
{ question: "При последовательном соединении одинакова?", options: ["Сила тока", "Напряжение", "Сопротивление", "Мощность"], correct: 0 },
{ question: "Формула мощности?", options: ["P = UI", "P = I/U", "P = U/I", "P = I²R"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
