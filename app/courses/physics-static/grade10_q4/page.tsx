  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Постоянный ток</h1>
          <p className="text-muted-foreground">Физика • 10 класс • 4 четверть</p>
        </div>
...
<p className="my-2"><strong>Постоянный ток</strong> — электрический ток, не изменяющийся со временем.</p>
<p className="my-2"><strong>Закон Ома для полной цепи:</strong> I = ε/(R+r), где ε — ЭДС источника, r — внутреннее сопротивление.</p>
<p className="my-2"><strong>Работа тока</strong> — A = UIt</p>
<p className="my-2"><strong>Мощность тока</strong> — P = UI</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">I = ε/(R+r) — закон Ома для полной цепи</p>
<p className="my-2">A = UIt — работа тока</p>
<p className="my-2">P = UI = I²R — мощность тока</p>
<p className="my-2">Q = I²Rt — закон Джоуля-Ленца</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. ЭДС батареи 12 В, внутреннее сопротивление 1 Ом, внешнее 5 Ом. Найдите силу тока.</p>
<p className="ml-4 text-muted-foreground">Решение: I = ε/(R+r) = 12/(5+1) = 2 А.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/uuDFGlhRmyg" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Закон Ома для полной цепи?", options: ["I = ε/(R+r)", "I = U/R", "I = εR", "I = ε·r"], correct: 0 },
{ question: "Формула работы тока?", options: ["A = UIt", "A = UI", "A = It", "A = Ut"], correct: 0 },
{ question: "Формула мощности тока?", options: ["P = UI", "P = U/I", "P = I/U", "P = It"], correct: 0 },
{ question: "Закон Джоуля-Ленца?", options: ["Q = I²Rt", "Q = IRt", "Q = UIt", "Q = I²R"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
