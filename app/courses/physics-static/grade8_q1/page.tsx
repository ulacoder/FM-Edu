...
export default function Lesson_grade8_q1() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Тепловые явления</h1>
          <p className="text-muted-foreground">Физика • 8 класс • 1 четверть</p>
        </div>
...
<p className="my-2"><strong>Тепловое движение</strong> — беспорядочное движение частиц вещества.</p>
<p className="my-2"><strong>Внутренняя энергия</strong> — энергия движения и взаимодействия частиц, из которых состоит тело.</p>
<p className="my-2"><strong>Теплопередача</strong> — процесс изменения внутренней энергии без совершения работы.</p>
<p className="my-2"><strong>Виды теплопередачи:</strong> теплопроводность, конвекция, излучение.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">Q = cm(t₂ - t₁) — количество теплоты при нагревании/охлаждении</p>
<p className="my-2">c — удельная теплоёмкость, Дж/(кг·°C)</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Какое количество теплоты потребуется для нагревания 2 кг воды от 20°C до 100°C? (c = 4200 Дж/(кг·°C))</p>
<p className="ml-4 text-muted-foreground">Решение: Q = cmΔt = 4200 · 2 · 80 = 672000 Дж = 672 кДж.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/MooL-bqwXPE" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Что такое внутренняя энергия?", options: ["Энергия движения и взаимодействия частиц тела", "Кинетическая энергия тела", "Потенциальная энергия", "Механическая энергия"], correct: 0 },
{ question: "Виды теплопередачи?", options: ["Теплопроводность, конвекция, излучение", "Только теплопроводность", "Только конвекция", "Только излучение"], correct: 0 },
{ question: "Формула количества теплоты?", options: ["Q = cmΔt", "Q = mΔt", "Q = cΔt", "Q = cmt"], correct: 0 },
{ question: "Единица количества теплоты?", options: ["Джоуль (Дж)", "Ватт (Вт)", "Ньютон (Н)", "Паскаль (Па)"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
