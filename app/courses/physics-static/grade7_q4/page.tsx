  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Давление</h1>
          <p className="text-muted-foreground">Физика • 7 класс • 4 четверть</p>
        </div>
...
<p className="my-2"><strong>Давление (p)</strong> — физическая величина, равная отношению силы, действующей перпендикулярно поверхности, к площади этой поверхности.</p>
<p className="my-2"><strong>Давление твёрдых тел</strong> зависит от силы и площади опоры.</p>
<p className="my-2"><strong>Давление жидкости</strong> на дно и стенки сосуда зависит от плотности жидкости и глубины.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">p = F / S</p>
<p className="my-2">p = ρgh (давление столба жидкости)</p>
<p className="my-2">Единица давления в СИ: Паскаль (Па)</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. На поверхность площадью 2 м² действует сила 1000 Н. Найдите давление.</p>
<p className="ml-4 text-muted-foreground">Решение: p = F/S = 1000 Н / 2 м² = 500 Па.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/qK8W90aXv-Q" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Что такое давление?", options: ["Отношение силы к площади поверхности", "Сила", "Площадь", "Масса"], correct: 0 },
{ question: "Формула давления?", options: ["p = F/S", "p = F·S", "p = S/F", "p = F+S"], correct: 0 },
{ question: "Единица давления в СИ?", options: ["Паскаль (Па)", "Ньютон (Н)", "Джоуль (Дж)", "Ватт (Вт)"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
