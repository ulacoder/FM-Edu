  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Динамика. Законы Ньютона</h1>
          <p className="text-muted-foreground">Физика • 9 класс • 2 четверть</p>
        </div>
...
<p className="my-2"><strong>Динамика</strong> — раздел механики, изучающий причины движения.</p>
<p className="my-2"><strong>I закон Ньютона (инерция):</strong> тело сохраняет состояние покоя или равномерного движения, если силы скомпенсированы.</p>
<p className="my-2"><strong>II закон Ньютона:</strong> F = ma (сила равна произведению массы на ускорение).</p>
<p className="my-2"><strong>III закон Ньютона:</strong> F₁ = -F₂ (силы взаимодействия равны и противоположны).</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">F = ma</p>
<p className="my-2">P = mg (вес тела)</p>
<p className="my-2">F_тр = μN (сила трения)</p>
<p className="my-2">F = Gm₁m₂/r² (закон всемирного тяготения)</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Тело массой 5 кг движется с ускорением 2 м/с². Найдите силу.</p>
<p className="ml-4 text-muted-foreground">Решение: F = ma = 5 · 2 = 10 Н.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/1OMFn8sLtUs" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "II закон Ньютона?", options: ["F = ma", "F = mv", "F = ma²", "F = m/a"], correct: 0 },
{ question: "Что такое инерция?", options: ["Сохранение состояния движения", "Изменение скорости", "Ускорение", "Торможение"], correct: 0 },
{ question: "Единица силы?", options: ["Ньютон (Н)", "Джоуль (Дж)", "Ватт (Вт)", "Паскаль (Па)"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
