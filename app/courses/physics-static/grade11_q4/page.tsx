  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Электромагнитные волны</h1>
          <p className="text-muted-foreground">Физика • 11 класс • 4 четверть</p>
        </div>
...
<p className="my-2"><strong>Электромагнитные волны</strong> — распространяющееся в пространстве переменное электромагнитное поле.</p>
<p className="my-2"><strong>Свойства ЭМВ:</strong> не требуют среды, распространяются со скоростью света, поперечные.</p>
<p className="my-2"><strong>Шкала ЭМВ:</strong> радиоволны, инфракрасное излучение, видимый свет, ультрафиолет, рентгеновское, гамма-излучение.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">c = λν — связь длины волны и частоты</p>
<p className="my-2">c = 3·10⁸ м/с — скорость света</p>
<p className="my-2">E = hν — энергия фотона</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Радиоволна имеет частоту 100 МГц. Найдите длину волны.</p>
<p className="ml-4 text-muted-foreground">Решение: λ = c/ν = 3·10⁸ / 10⁸ = 3 м.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/FWCN_uI5ygY" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Формула связи длины волны и частоты?", options: ["c = λν", "c = λ/ν", "c = λ + ν", "c = λ²ν"], correct: 0 },
{ question: "Скорость света в вакууме?", options: ["3·10⁸ м/с", "3·10⁶ м/с", "3·10¹⁰ м/с", "3·10⁴ м/с"], correct: 0 },
{ question: "ЭМВ распространяются?", options: ["Со скоростью света", "Со скоростью звука", "Мгновенно", "Очень медленно"], correct: 0 },
{ question: "Какие волны не требуют среды?", options: ["Электромагнитные", "Звуковые", "Механические", "Все требуют"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
