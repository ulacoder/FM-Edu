  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Механическое движение: скорость, путь, время</h1>
          <p className="text-muted-foreground">Физика • 7 класс • 2 четверть</p>
        </div>
...
<p className="my-2"><strong>Механическое движение</strong> — изменение положения тела в пространстве относительно других тел с течением времени.</p>
<p className="my-2"><strong>Траектория</strong> — линия, вдоль которой движется тело.</p>
<p className="my-2"><strong>Путь (s)</strong> — длина траектории, пройденной телом.</p>
<p className="my-2"><strong>Равномерное движение</strong> — движение, при котором тело за любые равные промежутки времени проходит одинаковый путь.</p>
<p className="my-2"><strong>Скорость (v)</strong> — величина, показывающая, какой путь проходит тело за единицу времени.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">v = s / t</p>
<p className="my-2">s = v · t</p>
<p className="my-2">t = s / v</p>
<p className="my-2">Единица скорости в СИ: м/с (также км/ч; 1 м/с = 3,6 км/ч)</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Велосипедист проехал 30 км за 2 часа. Найдите его скорость.</p>
<p className="ml-4 text-muted-foreground">Решение: v = s/t = 30 км / 2 ч = 15 км/ч.</p>
<p className="font-bold mt-4">Пример 2. Поезд движется со скоростью 72 км/ч. Какой путь он пройдёт за 0,5 часа?</p>
<p className="ml-4 text-muted-foreground">Решение: s = v·t = 72 · 0,5 = 36 км.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/3c5DDfffI0g" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Что называют механическим движением?", options: ["Изменение положения тела в пространстве относительно других тел со временем", "Любое движение тела", "Движение по прямой", "Быстрое движение"], correct: 0 },
{ question: "Что такое траектория?", options: ["Линия, вдоль которой движется тело", "Расстояние между телами", "Скорость тела", "Время движения"], correct: 0 },
{ question: "Формула скорости равномерного движения?", options: ["v = s/t", "v = s·t", "v = t/s", "v = s+t"], correct: 0 },
{ question: "Единица измерения скорости в СИ?", options: ["м/с", "км/ч", "м/мин", "см/с"], correct: 0 },
{ question: "Чему равен 1 м/с в км/ч?", options: ["3,6 км/ч", "0,36 км/ч", "36 км/ч", "10 км/ч"], correct: 0 },
{ question: "Как найти путь, зная скорость и время?", options: ["s = v·t", "s = v/t", "s = t/v", "s = v+t"], correct: 0 },
{ question: "Как найти время, зная путь и скорость?", options: ["t = s/v", "t = s·v", "t = v/s", "t = s+v"], correct: 0 },
{ question: "Какое движение называется равномерным?", options: ["Движение, при котором тело за любые равные промежутки времени проходит одинаковый путь", "Любое движение", "Медленное движение", "Быстрое движение"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
