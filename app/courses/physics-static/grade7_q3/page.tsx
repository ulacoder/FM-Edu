  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Плотность вещества</h1>
          <p className="text-muted-foreground">Физика • 7 класс • 3 четверть</p>
        </div>
...
<p className="my-2"><strong>Масса тела (m)</strong> — физическая величина, характеризующая инертность тела.</p>
<p className="my-2"><strong>Объём (V)</strong> — часть пространства, занимаемая телом.</p>
<p className="my-2"><strong>Плотность (ρ)</strong> — физическая величина, равная отношению массы тела к его объёму.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">ρ = m / V</p>
<p className="my-2">m = ρ · V</p>
<p className="my-2">V = m / ρ</p>
<p className="my-2">Единица плотности в СИ: кг/м³</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Масса стального бруска 780 г, объём 100 см³. Найдите плотность стали.</p>
<p className="ml-4 text-muted-foreground">Решение: ρ = m/V = 780 г / 100 см³ = 7,8 г/см³ = 7800 кг/м³.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/Y4fqU3wuf9w" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Что такое плотность вещества?", options: ["Отношение массы тела к его объёму", "Масса тела", "Объём тела", "Температура вещества"], correct: 0 },
{ question: "Формула плотности?", options: ["ρ = m/V", "ρ = m·V", "ρ = V/m", "ρ = m+V"], correct: 0 },
{ question: "Единица плотности в СИ?", options: ["кг/м³", "г/см³", "кг/л", "г/мл"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
