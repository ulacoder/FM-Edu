  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Законы сохранения</h1>
          <p className="text-muted-foreground">Физика • 9 класс • 3 четверть</p>
        </div>
...
<p className="my-2"><strong>Импульс тела</strong> — произведение массы тела на его скорость (p = mv).</p>
<p className="my-2"><strong>Закон сохранения импульса:</strong> в замкнутой системе суммарный импульс сохраняется.</p>
<p className="my-2"><strong>Механическая энергия</strong> — сумма кинетической и потенциальной энергии.</p>
<p className="my-2"><strong>Закон сохранения энергии:</strong> в замкнутой системе полная энергия сохраняется.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">p = mv (импульс)</p>
<p className="my-2">E_к = mv²/2 (кинетическая энергия)</p>
<p className="my-2">E_п = mgh (потенциальная энергия)</p>
<p className="my-2">E = E_к + E_п (полная механическая энергия)</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Тело массой 2 кг движется со скоростью 5 м/с. Найдите импульс.</p>
<p className="ml-4 text-muted-foreground">Решение: p = mv = 2 · 5 = 10 кг·м/с.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/nWZBKqb2W1w" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Формула импульса?", options: ["p = mv", "p = ma", "p = mv²", "p = m/v"], correct: 0 },
{ question: "Формула кинетической энергии?", options: ["E_к = mv²/2", "E_к = mv", "E_к = mgh", "E_к = ma"], correct: 0 },
{ question: "Закон сохранения энергии?", options: ["Полная энергия замкнутой системы постоянна", "Энергия исчезает", "Энергия увеличивается", "Энергия уменьшается"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
