  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Квантовая физика</h1>
          <p className="text-muted-foreground">Физика • 12 класс • 3 четверть</p>
        </div>
...
<p className="my-2"><strong>Фотоэффект</strong> — явление вырывания электронов из вещества под действием света.</p>
<p className="my-2"><strong>Законы фотоэффекта:</strong></p>
<p className="my-2">1. Количество электронов пропорционально интенсивности света.</p>
<p className="my-2">2. Максимальная энергия электронов не зависит от интенсивности, а зависит только от частоты.</p>
<p className="my-2">3. Существует красная граница фотоэффекта.</p>
<p className="my-2"><strong>Постулаты Бора:</strong></p>
<p className="my-2">1. Электрон движется по стационарным орбитам без излучения.</p>
<p className="my-2">2. Излучение происходит при переходе между орбитами: hν = E₂ - E₁.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">E = hν — энергия фотона</p>
<p className="my-2">p = h/λ — импульс фотона</p>
<p className="my-2">hν = A + E_к — уравнение Эйнштейна для фотоэффекта</p>
<p className="my-2">h = 6,62·10⁻³⁴ Дж·с — постоянная Планка</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Красная граница фотоэффекта для металла 5·10¹⁴ Гц. Найдите работу выхода.</p>
<p className="ml-4 text-muted-foreground">Решение: A = hν₀ = 6,62·10⁻³⁴ · 5·10¹⁴ = 3,31·10⁻¹⁹ Дж ≈ 2,07 эВ.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/h1z4w_GJr6k" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Что такое фотоэффект?", options: ["Вырывание электронов светом", "Излучение света", "Поглощение света", "Отражение света"], correct: 0 },
{ question: "Формула энергии фотона?", options: ["E = hν", "E = mc²", "E = mv²/2", "E = mgh"], correct: 0 },
{ question: "Уравнение Эйнштейна для фотоэффекта?", options: ["hν = A + E_к", "E = mc²", "F = ma", "pV = nRT"], correct: 0 },
{ question: "Постоянная Планка?", options: ["6,62·10⁻³⁴ Дж·с", "9,8 м/с²", "3·10⁸ м/с", "1,6·10⁻¹⁹ Кл"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
