  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Геометрическая оптика</h1>
          <p className="text-muted-foreground">Физика • 12 класс • 1 четверть</p>
        </div>
...
<p className="my-2"><strong>Закон отражения:</strong> угол падения равен углу отражения.</p>
<p className="my-2"><strong>Закон преломления:</strong> отношение синусов углов падения и преломления есть величина постоянная для двух сред.</p>
<p className="my-2"><strong>Линза</strong> — прозрачное тело, ограниченное сферическими поверхностями.</p>
<p className="my-2"><strong>Собирающая линза</strong> — утолщается к центру, фокусирует лучи.</p>
<p className="my-2"><strong>Рассеивающая линза</strong> — утончается к центру, рассеивает лучи.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">n₁sinα₁ = n₂sinα₂ — закон преломления</p>
<p className="my-2">1/F = 1/d + 1/f — формула тонкой линзы</p>
<p className="my-2">D = 1/F — оптическая сила (диоптрии)</p>
<p className="my-2">Γ = H/h = f/d — увеличение линзы</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Фокусное расстояние линзы 20 см. Найдите оптическую силу.</p>
<p className="ml-4 text-muted-foreground">Решение: D = 1/F = 1/0,2 = 5 дптр.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/Oh4m8Ees-3Q" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Закон отражения света?", options: ["Угол падения равен углу отражения", "Угол падения больше", "Угол отражения больше", "Углы не связаны"], correct: 0 },
{ question: "Формула тонкой линзы?", options: ["1/F = 1/d + 1/f", "F = d + f", "F = d·f", "1/F = d - f"], correct: 0 },
{ question: "Единица оптической силы?", options: ["Диоптрия (дптр)", "Метр (м)", "Ватт (Вт)", "Джоуль (Дж)"], correct: 0 },
{ question: "Собирающая линза имеет фокус?", options: ["Положительный", "Отрицательный", "Нулевой", "Бесконечный"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
