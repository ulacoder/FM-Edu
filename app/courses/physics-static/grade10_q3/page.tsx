  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Электростатика</h1>
          <p className="text-muted-foreground">Физика • 10 класс • 3 четверть</p>
        </div>
...
<p className="my-2"><strong>Электрический заряд</strong> — физическая величина, характеризующая способность тел участвовать в электромагнитном взаимодействии.</p>
<p className="my-2"><strong>Закон Кулона:</strong> сила взаимодействия двух точечных зарядов прямо пропорциональна произведению зарядов и обратно пропорциональна квадрату расстояния между ними.</p>
<p className="my-2"><strong>Электрическое поле</strong> — форма материи, посредством которой осуществляется взаимодействие зарядов.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">F = k|q₁q₂|/r² — закон Кулона</p>
<p className="my-2">E = F/q — напряжённость электрического поля</p>
<p className="my-2">C = q/U — электроёмкость конденсатора</p>
<p className="my-2">W = CU²/2 — энергия конденсатора</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Два заряда по 2·10⁻⁶ Кл находятся на расстоянии 0,1 м. Найдите силу взаимодействия (k = 9·10⁹).</p>
<p className="ml-4 text-muted-foreground">Решение: F = kq²/r² = 9·10⁹ · (2·10⁻⁶)² / 0,01 = 3,6 Н.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/kOek0ec0BRE" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Закон Кулона?", options: ["F = kq₁q₂/r²", "F = ma", "F = G m₁m₂/r²", "F = qE"], correct: 0 },
{ question: "Единица электрического заряда?", options: ["Кулон (Кл)", "Ампер (А)", "Вольт (В)", "Ом (Ом)"], correct: 0 },
{ question: "Формула напряжённости поля?", options: ["E = F/q", "E = Fq", "E = F/m", "E = qU"], correct: 0 },
{ question: "Единица ёмкости конденсатора?", options: ["Фарад (Ф)", "Кулон (Кл)", "Вольт (В)", "Джоуль (Дж)"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
