...
export default function Lesson_grade8_q2() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Агрегатные состояния вещества</h1>
          <p className="text-muted-foreground">Физика • 8 класс • 2 четверть</p>
        </div>
...
<p className="my-2"><strong>Плавление</strong> — переход вещества из твёрдого состояния в жидкое.</p>
<p className="my-2"><strong>Кристаллизация</strong> — переход из жидкого состояния в твёрдое.</p>
<p className="my-2"><strong>Парообразование</strong> — переход из жидкого состояния в газообразное.</p>
<p className="my-2"><strong>Конденсация</strong> — переход из газообразного состояния в жидкое.</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Ключевые формулы</h2>
<p className="my-2">Q = λm (количество теплоты при плавлении/кристаллизации)</p>
<p className="my-2">Q = Lm (количество теплоты при парообразовании/конденсации)</p>
<p className="my-2">λ — удельная теплота плавления</p>
<p className="my-2">L — удельная теплота парообразования</p>
            <h2 className="text-2xl font-bold mt-6 mb-4">Примеры решения задач</h2>
<p className="font-bold mt-4">Пример 1. Какое количество теплоты выделится при кристаллизации 5 кг воды при 0°C? (λ_льда = 3,4·10⁵ Дж/кг)</p>
<p className="ml-4 text-muted-foreground">Решение: Q = λm = 3,4·10⁵ · 5 = 1,7·10⁶ Дж = 1,7 МДж.</p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8 mb-8">
          ...
          <div className="aspect-video">
            <iframe className="w-full h-full rounded-lg" src="https://www.youtube.com/embed/iik25wqIuFo" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border/60 p-8">
          ...
          <Quiz questions={[
{ question: "Что такое плавление?", options: ["Переход из твёрдого состояния в жидкое", "Переход из жидкого в твёрдое", "Переход из жидкого в газ", "Переход из газа в жидкость"], correct: 0 },
{ question: "Формула количества теплоты при плавлении?", options: ["Q = λm", "Q = Lm", "Q = cm∆t", "Q = mgh"], correct: 0 },
{ question: "Что такое парообразование?", options: ["Переход из жидкого состояния в газообразное", "Переход из газа в жидкость", "Переход из твёрдого в жидкое", "Переход из жидкого в твёрдое"], correct: 0 }
          ]} />
        </div>
      </div>
    </div>
