      ...
      <main className="container mx-auto px-6">
        <section className="py-24 max-w-4xl mx-auto">
          <div className="text-center space-y-6">
            ...
            <div className="flex gap-4 justify-center pt-4">
              <Link
                href="/register"
                className="px-7 py-3.5 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 transition-colors"
              >
                Начать обучение
              </Link>
              <Link
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                <div
                  key={subject}
                  className="px-4 py-6 border border-gray-200 rounded-lg text-center hover:border-green-600 hover:bg-green-50 transition-colors"
                >
        ...
        <section className="py-20 border-t border-gray-100">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <Link
              href="/register"
              className="inline-block px-7 py-3.5 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 transition-colors"
            >
              Создать аккаунт
            </Link>
          </div>
