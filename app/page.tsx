...
export default function Home() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#D1F2EB' }}>
      {/* Header */}
      <header style={{ backgroundColor: '#D1F2EB', borderBottom: '1px solid #50C878' }}>
        <div className="container mx-auto px-6 py-5 flex justify-between items-center">
          ...
          <div className="flex gap-3">
            <Link
              ...
              style={{ color: '#013220' }}
              onMouseEnter={(e) => e.currentTarget.style.color = '#0B6E4F'}
              onMouseLeave={(e) => e.currentTarget.style.color = '#013220'}
            >
              Войти
            </Link>
            <Link
      ...
      <main className="container mx-auto px-6">
        <section className="py-24 max-w-4xl mx-auto">
          <div className="text-center space-y-6">
            ...
            <p className="text-lg max-w-2xl mx-auto leading-relaxed" style={{ color: '#0B6E4F' }}>
            ...
            <div className="flex gap-4 justify-center pt-4">
              ...
              <Link
                ...
                style={{ borderColor: '#0B6E4F', color: '#013220', backgroundColor: 'white' }}
                onMouseEnter={(e) => {
                ...
                onMouseLeave={(e) => {
                  ...
                  e.currentTarget.style.color = '#013220';
                }}
              >
                Пройти диагностику
              </Link>
        ...
        {/* Features */}
        <section className="py-20" style={{ borderTop: '1px solid #50C878' }}>
          <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
            <div className="space-y-3">
              ...
              <p className="text-sm leading-relaxed" style={{ color: '#0B6E4F' }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                <div
                  ...
                  style={{ borderColor: '#50C878', backgroundColor: 'white' }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.borderColor = '#0B6E4F';
                    e.currentTarget.style.backgroundColor = '#0B6E4F';
                  ...
                  onMouseLeave={(e) => {
                    ...
                    e.currentTarget.style.backgroundColor = 'white';
                    const text = e.currentTarget.querySelector('div');
                    if (text) text.style.color = '#013220';
                  }}
                >
                  <div className="text-sm font-medium transition-colors" style={{ color: '#013220' }}>{subject}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20" style={{ borderTop: '1px solid #50C878' }}>
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg" style={{ color: '#0B6E4F' }}>
      ...
      {/* Footer */}
      <footer style={{ borderTop: '1px solid #50C878', marginTop: '5rem' }}>
