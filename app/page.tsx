...
export default function Home() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#F5F3FF' }}>
      {/* Header */}
      <header style={{ backgroundColor: '#F5F3FF', borderBottom: '1px solid #8B5CF6' }}>
        <div className="container mx-auto px-6 py-5 flex justify-between items-center">
          ...
          <div className="flex gap-3">
            <Link
              ...
              onMouseLeave={(e) => e.currentTarget.style.color = '#1F1B2E'}
            >
              Войти
            </Link>
            <Link
      ...
      <main className="container mx-auto px-6">
        <section className="py-24 max-w-4xl mx-auto">
          <div className="text-center space-y-6">
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight leading-tight" style={{ color: '#1F1B2E' }}>
              Персонализированное<br />образование с AI
            </h1>
            <p className="text-lg max-w-2xl mx-auto leading-relaxed" style={{ color: '#8B5CF6' }}>
            ...
            <div className="flex gap-4 justify-center pt-4">
              ...
              <Link
                ...
                style={{ borderColor: '#8B5CF6', color: '#1F1B2E', backgroundColor: 'white' }}
                onMouseEnter={(e) => {
                ...
                onMouseLeave={(e) => {
                  ...
                  e.currentTarget.style.color = '#1F1B2E';
                }}
              >
                Пройти диагностику
              </Link>
        ...
        {/* Features */}
        <section className="py-20" style={{ borderTop: '1px solid #8B5CF6' }}>
          <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
            <div className="space-y-3">
              ...
              <h3 className="text-lg font-semibold" style={{ color: '#1F1B2E' }}>Адаптивный план</h3>
              <p className="text-sm leading-relaxed" style={{ color: '#8B5CF6' }}>
            ...
            <div className="space-y-3">
              ...
              <h3 className="text-lg font-semibold" style={{ color: '#1F1B2E' }}>Программа МОН РК</h3>
              <p className="text-sm leading-relaxed" style={{ color: '#8B5CF6' }}>
            ...
            <div className="space-y-3">
              ...
              <h3 className="text-lg font-semibold" style={{ color: '#1F1B2E' }}>Обратная связь</h3>
              <p className="text-sm leading-relaxed" style={{ color: '#8B5CF6' }}>
        ...
        <section className="py-20" style={{ borderTop: '1px solid #8B5CF6' }}>
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl font-bold mb-12" style={{ color: '#1F1B2E' }}>Предметы</h2>
              ...
              {[
                ...
                <div
                  ...
                  onMouseLeave={(e) => {
                    ...
                    e.currentTarget.style.backgroundColor = 'white';
                    const text = e.currentTarget.querySelector('div');
                    if (text) text.style.color = '#1F1B2E';
                  }}
                >
                  <div className="text-sm font-medium transition-colors" style={{ color: '#1F1B2E' }}>{subject}</div>
                </div>
              ))}
            </div>
          </div>
