    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 bg-muted/20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {/* Profile Card */}
          <div className="bg-card border border-border/60 rounded-lg overflow-hidden mb-8">
            ...
            <div className="px-8 pb-8">
              ...
              <div className="flex justify-between items-start -mt-16 mb-6">
                <div className="w-32 h-32 bg-card border-4 border-card rounded-full flex items-center justify-center shadow-lg">
                  <User className="w-16 h-16 text-primary" />
                </div>
                {!isEditing ? (
                  <button
                    onClick={() => setIsEditing(true)}
                    className="mt-20 px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors flex items-center gap-2"
                  >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="text-lg font-semibold">{user.grade} класс</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold">{displayLevel}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-card border border-border/60 rounded-lg p-6">
            <h2 className="text-xl font-bold mb-4">Действия с аккаунтом</h2>
            <div className="space-y-3">
              <button className="w-full px-4 py-3 bg-muted hover:bg-muted/80 rounded-lg transition-colors text-left font-medium">
                Изменить пароль
              </button>
              <button className="w-full px-4 py-3 bg-muted hover:bg-muted/80 rounded-lg transition-colors text-left font-medium">
                Настройки уведомлений
              </button>
              <button className="w-full px-4 py-3 bg-destructive/10 hover:bg-destructive/20 text-destructive rounded-lg transition-colors text-left font-medium">
                Удалить аккаунт
              </button>
            </div>
          </div>
