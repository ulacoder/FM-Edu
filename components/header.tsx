            ...
            {isAuthenticated ? (
              <>
                ...
                <button
                  ...
                  className="px-2 py-1 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium hover:text-primary transition-colors hidden sm:inline-block"
                >
                  {t('logout')}
                </button>
              </>
              ...
              <>
                <Link href="/login" className="hidden sm:inline-block">
                  <button className="px-2 py-1 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium hover:text-primary transition-colors">
                    {t('login')}
                  </button>
                </Link>
                <Link href="/register">
