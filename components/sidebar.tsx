    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed top-3 left-3 sm:top-4 sm:left-4 z-[100] p-0.5 sm:p-2 bg-card border-2 border-purple-600 rounded-lg shadow-lg hover:bg-muted transition-colors"
